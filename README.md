...
Simple in-memory HashMap CLI implemented in Python. Supports add/update, search, delete and display of entries using integer keys and string values.
...
- store_data(key, name) — insert or update a (key, name) pair
- input_menu(), search_menu(), delete_data(), operations_menu() — interactive handlers
